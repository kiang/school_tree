...
var vectorPoints = new ol.layer.Vector({
  source: new ol.source.Vector({
    ...
    url: 'https://kiang.github.io/edutreemap.moe.edu.tw/json/school.json'
  }),
...
function showPoint(pointId) {
  ...
  $.getJSON('https://kiang.github.io/edutreemap.moe.edu.tw/json/school/' + pointId + '.json', function (c) {
    currentSchool = c;
...
var findTerms = [];
$.getJSON('https://kiang.github.io/edutreemap.moe.edu.tw/json/tree.json', {}, function (items) {
  for (k in items) {
    findTerms.push({
      value: k,
      label: k + ' ' + items[k]
